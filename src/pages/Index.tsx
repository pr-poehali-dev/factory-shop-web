            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed mb-4">Завод «Арсенал» основан в 2006 году и специализируется на производстве электронных компонентов для промышленной, военной и гражданской электроники. За более чем 20 лет работы мы поставили продукцию более чем 1 200 предприятиям России и СНГ.
</p>

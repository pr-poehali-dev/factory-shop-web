            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 space-y-4">
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-6">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed mb-4">АО «Краснознаменский завод полупроводниковых приборов «Арсенал» основан в 1999 году и является современным динамичным частным предприятием. Завод занимается разработкой и серийным изготовлением полупроводниковых и электротехнических компонентов. Особое внимание уделяется качеству выпускаемой продукции. Которая благодаря этому обладает повышенными надёжностными характеристиками и успешно применяется в аппаратуре связи, авиации и космоса.</p>
